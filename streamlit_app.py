...
def main():
    ...
    st.markdown('Ambil data dari database lalu rename jadi **THC.csv**,')
    st.markdown('Upload file tersebut, untuk detailnya ada dalam bentuk file excel.')
    st.markdown('Jika file nya di olah manual, ubah bagian header menajadi seperti ini:')
